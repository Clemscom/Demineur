...
police = pygame.font.SysFont("Arial",16,True) 
...
def draw_number(col:int,lig:int):
    ...
    if tab_bombe[col,lig] != 0 :
        screen.blit(police.render(str(int(tab_bombe[col][lig])),True,COLOR[int(tab_bombe[col,lig])-1]), ((col)*taille_case+taille_case/4,(lig)*taille_case+taille_case/5))
